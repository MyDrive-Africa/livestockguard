...
app.include_router(robots_router, prefix=f"/api/{API_VERSION}/robots", tags=["robots"])
...
app.include_router(robots_router, prefix="/api/robots", tags=["robots"], include_in_schema=False)
